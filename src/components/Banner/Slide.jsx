...
const Slide = ({image, text}) => {
  return (
    <div
      className="w-full bg-center bg-cover h-[300px] lg:h-[38rem]"
      style={{
        backgroundImage: `url(${image})`,
      }}
    >
      <div className="flex items-center justify-center w-full lg:h-full bg-gray-900/70">
